...
displacement.canvas.style.width = "150px";
displacement.canvas.style.height = "150px";
...
particlesGeometry.setIndex(null); // improve the performance
...
const particlesMaterial = new THREE.ShaderMaterial({
  ...
  blending: THREE.AdditiveBlending, // improve performance
});

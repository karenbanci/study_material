"""
I found evidence of:
- split_set() randomly assigns indirect indices to lists
- prime_data generates new deques for test, train or both
- get_one_item returns a tuple with corresponding features and labels
- number of samples returns the correct number based on the value of target_set
- pool_is_empty returns the correct boolean value in all circumstances
- repeated code is kept to a minimum

Be sure to keep lines of code to 79 chars Max.

Excellent Work: 14/15
"""
...
class NNData:
    ...
    def _empty_data_and_split_set(self):
        """
        This method avoids repeated code that will be used to empty data in load_data()
        """
        self.empty_data()
    ...
    def load_data(self, features, labels):
        ...
        if len(features) != len(labels):
            self._empty_data_and_split_set()
...
"""
/Users/karenbanci/opt/anaconda3/bin/python /Users/karenbanci/code/Foothill/Project CS_3B_Winter_2023/CS_3B_Winter_2023/ProjectNNData/NNDataFinal.py 
Train Indices:[2, 8, 0]
Test Indices:[1, 7, 4, 3, 6, 9, 5]
No errors were identified by the unit test.
